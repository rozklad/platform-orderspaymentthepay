<?php namespace Sanatorium\Orderspaymentthepay\Component\DataApi;

use Sanatorium\Orderspaymentthepay\Component\DataApi\Exceptions\TpInvalidArgumentException;
